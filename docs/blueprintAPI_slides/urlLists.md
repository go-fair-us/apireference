...
### **Slide 7: APIs and the Blueprint**
...
### **Slide 9: The Web, APIs and the Request Response Sequence**
...
### **Slide 17: Describe (Document) Your API**
...
### **Slide 18: Fun with Descriptions**
...
### **Slide 19: A quick Example From the Notebook**
...
### **Slide 22: APIs in NIAID**
  ...
  * **BioPortal Terms Redirect:** [http://bioportal.bioontology.org/ontologies/EDAM?p=terms\&conceptid=topic\_0622](http://bioportal.bioontology.org/ontologies/EDAM?p=terms%26conceptid=topic_0622)
  * **NIAID API Links Table:** [https://github.com/go-fair-us/apireference/blob/master/docs/niaidAPILinksTable.md](https://github.com/go-fair-us/apireference/blob/master/docs/niaidAPILinksTable.md)
